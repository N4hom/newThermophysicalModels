...
#include "heMyThermo.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class BasicPsiThermo, class MixtureType>
void Foam::heMyThermo<BasicPsiThermo, MixtureType>::calculate
(
...
template<class BasicPsiThermo, class MixtureType>
Foam::heMyThermo<BasicPsiThermo, MixtureType>::heMyThermo
(
    const fvMesh& mesh,
...
:
    ...
    initialize_(true)
{
    Info << "Constructing heMyThermo " << endl;
    calculate
    (
        this->p_,
        this->T_,
    ...
    Info << "heMyThermo constructed " << endl;
...
template<class BasicPsiThermo, class MixtureType>
void Foam::heMyThermo<BasicPsiThermo, MixtureType>::correct()
{
...
template<class BasicPsiThermo, class MixtureType>
void Foam::heMyThermo<BasicPsiThermo, MixtureType>::updateP(volScalarField& rho, volScalarField& T)
{
