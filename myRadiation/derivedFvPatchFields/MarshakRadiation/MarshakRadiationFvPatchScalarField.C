...
Foam::myRadiation::MarshakRadiationFvPatchScalarField::
...
void Foam::myRadiation::MarshakRadiationFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void Foam::myRadiation::MarshakRadiationFvPatchScalarField::write
(
    Ostream& os
) const
{
