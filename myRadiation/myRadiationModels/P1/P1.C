...
Foam::myRadiation::P1::P1(const volScalarField& T)
:
    myRadiationModel(typeName, T),
    G_
    (
        IOobject
        (
...
:
    myRadiationModel(typeName, dict, T),
    G_
    (
        IOobject
        (
...
bool Foam::myRadiation::P1::read()
{
    if (myRadiationModel::read())
    {
        // nothing to read
...
Foam::tmp<Foam::volScalarField> Foam::myRadiation::P1::Rp() const
{
...
Foam::label Foam::myRadiation::P1::nBands() const
{
